...
| Metrics tracker | Prepare manual feedback rows and linked verification records for selected improvements; preserve the first pass, connect the change and comparable retest, and keep user usefulness and lesson candidates separate | [Pilot feedback tracker](../templates/stage-5-pilot-feedback-tracker-template.md#verification-of-an-improvement), existing evaluation and change-log evidence |
