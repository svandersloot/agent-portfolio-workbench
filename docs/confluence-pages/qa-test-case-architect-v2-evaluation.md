...
| QATCA-EVAL-016 | Production conflict | Gathered production context (epic/story, issue links, Confluence search) contains conflicting source evidence. | Does not resolve the conflict; generates only safe non-conflicting tests and logs the conflict for human review. | Not Run |
