...
| MOBRM standard published to ROVO | Done | Published as the active MOBRM team overlay under Team Jira Standards. |
| Active standards validated | Open | Validate organization-wide fallback and MOBRM overlay behavior. |
