...
| QA Test Strategy Planner | Governed agent | Pilot Approved | Needs Cleanup | Support QA strategy, test planning, automation handoff, and QA deliverable readiness. | Lisa Porter pilot | Shayne Vandersloot | TBD | QA Test Strategy Planner Project Brain (`5403017262`) | User-provided Confluence Project Brain; repo-backed source details not yet captured | Pilot feedback and measurement path needed | Pilot-only; not broadly approved | QA planning context; confirm sensitive-data handling before broader use | 2026-06-23 | Confirm backup owner, measurement plan, approved sources, Studio configuration evidence, and pilot feedback path. |
