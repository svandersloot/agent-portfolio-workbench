...
| **R-8** | Dataset/coverage | EVAL-030 not exercised by any attached prompt; **EVAL-031 (source isolation) is not yet defined** as an evaluation case or dataset row on `origin/main`; Categories 2/3/5/7 not rerun. | n/a | Evaluation-dataset defect / missing coverage | L |
